    ...
    <aside className="rounded-[30px] border border-white/10 bg-[linear-gradient(180deg,rgba(11,23,58,0.95),rgba(6,12,30,0.95))] p-5 shadow-[0_20px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl">
      <div className="mb-8 flex items-center gap-3">
        ...
        <div>
          ...
          <div className="text-lg font-extrabold">Student Portal</div>
        </div>
      </div>
      ...
      <div className="mt-8 grid gap-4">
        <div className="rounded-[24px] border border-blue-400/20 bg-[linear-gradient(135deg,rgba(62,86,230,0.35),rgba(109,58,209,0.28))] p-4 shadow-[0_10px_40px_rgba(61,89,255,0.18)]">
          ...
          <h3 className="text-lg font-bold">AI assessment dashboard</h3>
          <p className="mt-2 text-sm leading-6 text-blue-100/75">
            Upload files, review feedback, compare reports, and track your progress in one place.
          </p>

          <div className="mt-4 grid gap-2">
            <InfoPill icon={<FileText size={14} />} text="Report insights" />
            <InfoPill icon={<Activity size={14} />} text="Live processing" />
            <InfoPill icon={<Sparkles size={14} />} text="AI powered feedback" />
          </div>
        </div>
